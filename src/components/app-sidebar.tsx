...
import { Menu, Users, MapPin, Shield, Calendar, QuoteIcon, Wand2, BookText, PenTool, BookCopy, UsersRound, Bug } from "lucide-react";
...
const navItems = [
    ...
    { href: "/debug", icon: Bug, label: "Debug Info" },
];
